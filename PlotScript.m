...
grid on;
grid minor;
title('Input Voltage Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Voltage (V)');
xlabel('Time (s)');
%% Output Voltage
figure;
...
grid on;
grid minor;
title('Output Voltage Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Voltage (V)');
xlabel('Time (s)');
%% Output Current
figure;
...
grid on;
grid minor;
title('Armature Current Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Current (A)');
xlabel('Time (s)');
%% IGBT Voltage
figure;
...
grid on;
grid minor;
title('IGBT Voltage Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Voltage (V)');
xlabel('Time (s)');
%% IGBT Current
figure;
...
grid on;
grid minor;
title('IGBT Current Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Current (A)');
xlabel('Time (s)');
%% Diode Voltage
figure;
...
grid on;
grid minor;
title('Freewheeling Diode Voltage Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Voltage (V)');
xlabel('Time (s)');
%% Diode Current
figure;
...
grid on;
grid minor;
title('Freewheeling Diode Current Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Current (A)');
xlabel('Time (s)');
%% Input Current
figure;
...
grid on;
grid minor;
title('Input Current Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Current (A)');
xlabel('Time (s)');
...
grid on;
grid minor;
title('Three Phase Full-Bridge Rectifier Output Voltage Waveform (f_s = 5 kHz & D = 0.8)');
ylabel('Voltage (V)');
xlabel('Time (s)');